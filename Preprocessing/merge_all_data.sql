...
create table sf as select san_francisco_weather.year, san_francisco_weather.doy, san_francisco_weather.hourmin, san_francisco_weather.temperature, san_francisco_weather.humidity, san_francisco_weather.pressure, groupby_sf.count as firecount from san_francisco_weather left join groupby_sf on (san_francisco_weather.year = groupby_sf.year) and (san_francisco_weather.doy = groupby_sf.doy) and (san_francisco_weather.hourmin = groupby_sf.hourmin);

create table la as select los_angeles_weather.year, los_angeles_weather.doy, los_angeles_weather.hourmin, los_angeles_weather.temperature, los_angeles_weather.humidity, los_angeles_weather.pressure, groupby_la.count as firecount from los_angeles_weather left join groupby_la on (los_angeles_weather.year = groupby_la.year) and (los_angeles_weather.doy = groupby_la.doy) and (los_angeles_weather.hourmin = groupby_la.hourmin);

create table sd as select san_diego_weather.year, san_diego_weather.doy, san_diego_weather.hourmin, san_diego_weather.temperature, san_diego_weather.humidity, san_diego_weather.pressure, groupby_sd.count as firecount from san_diego_weather left join groupby_sd on (san_diego_weather.year = groupby_sd.year) and (san_diego_weather.doy = groupby_sd.doy) and (san_diego_weather.hourmin = groupby_sd.hourmin);

delete from sf where temperature = '' and humidity = '' and pressure = '';
delete from la where temperature = '' and humidity = '' and pressure = '';
delete from sd where temperature = '' and humidity = '' and pressure = '';
